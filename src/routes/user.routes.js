...
userRouter.route("/updateUserAvatar").patch(upload.single('avatar'),verifyJWT,UpdateUserAvatar)
userRouter.route("/updateUserCoverImage").patch(upload.single('coverImage'),verifyJWT,UpdatUserCoverImage)
